...
import { useGetPurchaseDataQuery } from "../../api/dashboard";

const PurchaseChart = ({ companies }) => {
  ...
  return (
    <div className="w-full bg-white p-6 rounded-2xl shadow-sm border border-gray-200 -z-1">
      {/* Enhanced Header */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
        <div className="mb-4 lg:mb-0">
