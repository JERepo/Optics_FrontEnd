...
const BrandCategory = () => {
  ...
  const { data, isLoading } = useGetAllBrandCatsQuery();
  ...
  const brands = useMemo(() => {
    ...
    return processed;
  }, [data, searchQuery, sortConfig, searchQuery]);
    ...
    <div className="max-w-5xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <HasPermission module="Brand catagory" action="create">
            <Button
              icon={FiPlus}
              iconPosition="left"
      ...
      <Table
        columns={["S.No", "Brand Category", "created on", ""]}
        data={paginatedPools}
        renderHeader={(column) => {
          if (column === "Brand Category") {
            return (
          ...
          <TableRow key={pool.id}>
            ...
            <TableCell>
              <div className="flex items-center gap-3">
                ...
                <HasPermission module="Brand catagory" action="deactivate">
                  <Toggle
      ...
      <ConfirmationModal
        ...
        message={`This will ${
          currentStatus ? "deactivate" : "activate"
        } the Brand Category. You can change it again later.`}
