...
import {  useLazyGetPurchaseOrderReportQuery, useLazyGetStockInReportQuery } from "../../api/reportApi";
import { useSelector } from "react-redux";
import toast from "react-hot-toast";

const reportTypes = [
  { value: 0, label: "Stock Transfer In Details" },
...
const STINReport = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      downloadFile(blob, "StockTransferIn Details.xlsx");
      toast.success("StockTransferIn Details Generated successfully!");
      ...
      const errorMsg =
        ...
        error?.message ||
        "Looks like there are no pending StockTransferIn Details right now.";
    ...
    <div>
      <div className="max-w-8xl">
        <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6">
          {/* Header */}
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-gray-900">StockTransferIn Details</h2>
          </div>
