...
const reportTypes = [
  { value: 0, label: "Detailed Purchase Return" },
  // { value: 1, label: "Tally Purchase Return" },
  { value: 1, label: "Purchase Return by Product Type" },
];
...
const handleDateTypeChange = (_, newValue) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      downloadFile(blob, "Purchase Return Report.xlsx");
      toast.success("Purchase Return Report Generated successfully!");
      ...
      const errorMsg =
        ...
        error?.message ||
        "Looks like No purchase return data found!";
    ...
    <div>
      <div className="max-w-8xl">
        <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6">
          {/* Header */}
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-gray-900">Purchase Return Report</h2>
          </div>
