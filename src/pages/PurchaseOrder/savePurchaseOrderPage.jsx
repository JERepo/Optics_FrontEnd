  ...
  const handleSubmit = async () => {
    try {
      ...
      const payload = {
        ...
        shiptoCompanyId:
          formState?.vendorDetails?.MultiDelivery === 1
            ? parseInt(selectedLocation)
            : formState?.vendorDetails?.DeliveryLocationId,
      ...
      setAlertMessage({
        type: "error",
        message:
          error.message || "An error occurred while creating purchase order",
      });
      setShowAlert(true);
      setTimeout(() => setShowAlert(false), 3000);
    }
        ...
        {selectedVendor && (
          ...
          >
            ...
            <div className="flex mt-6 space-x-16">
              <p className="text-gray-700 ">
                <span className="font-bold flex">Ship to address : </span>
              </p>
